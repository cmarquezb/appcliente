...
router.get('/', function(req, res, next) {
	req.getConnection(function(err,connection){
        ...
        var sql = "SELECT ot.idOT AS value1, ot.idOT AS label,";
            ...
            sql +=" ot.idArea AS value3, ot.Estados_idEstados AS value4, ot.Equipos_idEquipos AS value5,";
            sql +=" ot.Servicios_idServicios AS value6, ot.Centro_idCentro AS value7, ot.Clientes_idClientes AS value8,";
